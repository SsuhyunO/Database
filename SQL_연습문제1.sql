...
INSERT INTO Customer VALUES ("c108", "이순신", "010-1234-1008", "서울시 영동포구", "2022-01-08");
...
#실습 1-28
SELECT orderProduct, orderId, SUM(orderCount) AS "총 주문수량" FROM `Order` GROUP BY orderProduct, orderId ORDER BY orderProduct, orderId;
